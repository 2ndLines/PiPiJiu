...
public interface SmsService {
     ...
     * @return
     */
    @POST("ResponseBodysByMobilePhone")
    Call<ResponseBody> signInByMobilePhone(@Body ServiceBody body);
     ...
     */
    @GET("login")
    Call<ResponseBody> loginByMobilePhone(@Query(value = "mobilePhoneNumber", encoded = true) String phoneNumber, @Query(value = "password", encoded = true) String password);
